...
export class Backend implements backendInterface {
    ...
    async addRecord(arg0: Key, arg1: Row): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRecord(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async containsKey(arg0: Key): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.containsKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecord(arg0: Key): Promise<Record_> {
        if (this.processError) {
            try {
    ...
    async getSize(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getSize();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
